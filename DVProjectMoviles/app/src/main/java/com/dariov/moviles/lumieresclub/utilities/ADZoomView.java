...
public class ADZoomView extends FrameLayout {
    private boolean _iScroll = false;

    public ADZoomView(final Context context) {
        super(context);
    }

    public ADZoomView(final Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ADZoomView(final Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setiScroll(boolean iScroll){
        _iScroll = iScroll;
    }
    ...
    public boolean dispatchTouchEvent(final MotionEvent ev) {
            ...
            if (listener != null) {
                if (smoothZoom <= 1.0f) {
                    listener.onZoomEnable(true);
                } else {
                    listener.onZoomEnable(false);
                }
            }
    ...
    public interface ZoomViewListener {
        ...
        void onZoomEnable(boolean enable);
    }
}